...
CUSTOM_MODEM=BBK_P60_P0MP3_K71V1_64_BSP_LWCTG_CUSTOM_BBKMake_PD1813F_EX_n
...
BBK_PRODUCT_VERSION=PD1813F_EX_A_6.13.8
BBK_PRODUCT_HARDWARE_VERSION=PD1813F_EXMA
BBK_HARDWARE_VERSION=PD1813F_EXMA
BBK_BOARD_VERSION=MA
BBK_OTA_ARGS=-n -e vendor/vivo/config/ota_scripts/ard8.1_9.0_extra_script
...
BBK_PRODUCT_LOCALES=en_US zh_CN zh_TW zh_HK th_TH ms_MY my_MM my_ZG in_ID bn_BD gu_IN mr_IN te_IN ta_IN hi_IN ur_PK tl_PH vi_VN lo_LA km_KH kn_IN ml_IN ru_RU ar_EG pa_IN or_IN as_IN bh_MA it_IT es_ES es_US si_LK pt_PT pt_BR ne_NP nl_NL fr_FR de_DE sa_IN ja_JP ko_KR hdpi xxhdpi
BBK_FOR_NET_ENTRY=
BBK_FOR_OP_ENTRY=no
BBK_PRODUCT_CUSTOMIZE_LIST=
BBK_PRODUCT_RADIO_TYPE_LIST=
BBK_PRODUCT_RADIO_TYPE_ABBR=F
BBK_LTE_VOICE_TYPE=CSFB
BBK_OPERATOR_SOFTWARE_VERSION_NUMBER=29
BBK_TARGET_RELEASETOOLS_EXTENSIONS=vendor/vivo/build/releasetools/mtk/mt6771_9.0
BBK_SPEC_CUSTOM_APP=ifly_ivw30 awox_dlna fingerprint gaode SeedKeeper OemDomainsConfig_domains secureService Vivodefend
...
BBK_THIRD_PARTY_MODEL=PD1813F_EX_9.0
...
BBK_PROPERTIYS_RO=
BBK_PROPERTIYS_OVERRIDES=ro.product.first_api_level=27 ro.config.notification_sound=Whistle.ogg ro.config.alarm_alert=Fine_Day.ogg ro.config.message_sound=Default.ogg ro.config.ringtone=Blue_Meteor_Showers.ogg ro.kernel.android.checkjni=0 ro.ril.dtmf_interval=200 ro.ril.dtmf_pause_interval=100
WIFI_PARAMETER_PD1813F_EX_9_0=yes
...
MTK_IPOH_SUPPORT=no
MTK_IPO_SUPPORT=no
CUST_FEATURE_ALSPS_PARAMETER_FORPD1813=yes
